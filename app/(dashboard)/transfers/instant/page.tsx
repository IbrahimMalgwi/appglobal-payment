...
import { instantTransfers as seedTransfers } from "@/lib/mock-data";
...
export default function InstantTransferPage() {
  ...
  function handleSend() {
    ...
    setTimeout(() => {
      ...
      setBank("");
      setAmount("");
      showToast(`₦${parsedAmount.toLocaleString()} sent to ${recipient}.`);
    }, 700);
  }

  return (
    <div>
      <PageHeader title="Transfers" description="Send money instantly to any bank account." />
      <div className="mb-5">
        <RouteTabs tabs={tabs} />
      </div>
      <TransfersTable
